...
# Install the pacman package if you haven't already
...
mockdata <- rio::import(here("IndependentActivity2_Pt2","data", "chlamydia_linelist.csv"), 
                        header = TRUE)
...
ggsave(here("IndependentActivity2_Pt2", "output", "epi_curve_female.png"), # Saves figure in output folder
...
ggsave(here("IndependentActivity2_Pt2", "output", "epi_curve_male.png"), # Saves figure in output folder
...
ggsave(here("IndependentActivity2_Pt2", "output", "female_cases_partners_NAs.png"), # Saves figure in output folder
...
ggsave(here("IndependentActivity2_Pt2", "output", "male_cases_partners_NAs.png"), # Saves figure in output folder
       width = 11.5, height = 13) # Specifies size
