...
Welcome to the PHAC Training and Development Unit's (TDU) Data Visualization in R course! Here, we'll keep a record of all the files necessary to attend and complete the course. If you're not familiar working in Github, you can treat this as an online folder for accessing course resources. Please be sure to review the course participant guide for an overview of how the course works. 
...
![image](https://user-images.githubusercontent.com/106621279/234065355-ffda4e9d-cf3a-4e28-a819-011aa34da8a3.png)
